...
public class VolleyballFragment extends Fragment{
    ...
    private void setUpRecyclerView(View view) {
        Query query = dbRef.whereEqualTo("category", "Volleyball").whereEqualTo("status", "1").orderBy("date", Query.Direction.ASCENDING).orderBy("time", Query.Direction.ASCENDING);
        ...
        RecyclerView recyclerView = view.findViewById(R.id.recycler_view_volleyball);
