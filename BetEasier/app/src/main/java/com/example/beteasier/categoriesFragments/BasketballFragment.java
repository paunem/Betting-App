...
public class BasketballFragment extends Fragment{
    ...
    private void setUpRecyclerView(View view) {
        Query query = dbRef.whereEqualTo("category", "Basketball").whereEqualTo("status", "1").orderBy("date", Query.Direction.ASCENDING).orderBy("time", Query.Direction.ASCENDING);
